...
describe("Testing Topics Endpoints", () => {
  ...
  describe("Get topics from database", () => {
    ...
    it("Should get topics by ids", async done => {
      ...
      const response = await request.post("/topics/id")
        .send({ ids: ids });
  ...
  describe("Create topic", () => {
    ...
    it.skip("Should create topic", async done => {
    ...
    it("Should fail when creating a topics with duplicate topicName", async done => {
      const response = await request.post("/topics/")
        .send({ topicName: "Topic 1", description: "Description", createdUserId: "5fb1fe18120bbf113438078c" });
